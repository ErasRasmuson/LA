...
def start():
	...
	#set_rcl_file("EPT.rcl")
	#set_sbk_file("EPT","SBK_ID","BUS","LINE","DIR","SIGN","RTAT_SRCH_TIME","LOGIN","DRIVE","RTAT_MSG","RTAT_VAL",
	#			 "PASS","BQD_MSG","AD_MSG","AD_VAL","RTAT_AD_VAL","PASS_LOGIN","PASS_DRIVE","PASS_RTAT","PASS_TIME_ERR",
	#			 "BQD_TIME_ERR","EPT_ERR","LOGIN_WARN","BQD_WARN")
