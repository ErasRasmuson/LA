...
ESU["BEGIN"] = {
	...
	"log_filename_expr":    "TaxiRides.csv",
...
ESU["END"] = {
	...
	"log_filename_expr":    "TaxiRides.csv_<SET-RIDEID>",
...
def start():
	...
	set_sbk_file("Taxi_LongRides_Big","SET-RIDEID","startTime","endTime")
	copy_variable("STARTTIME-BEGIN","STARTTIME")

	logfiles_data.read("/home/esa/projects/LA/LogFile/PreProsessed/TaxiRides/TaxiRides.csv","startTime")
	logfiles_data.transform_operation_keyby("/home/esa/projects/LA/LogFile/PreProsessed/TaxiRides/TaxiRides.csv","rideId")
