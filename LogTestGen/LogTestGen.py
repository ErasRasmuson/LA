...
class TestModel:
	...
	def write_trace_pattern_logs(self,tble_max,tbnu_max,tle_max,tnu_max,btre_max,file_info):
		...
		# Lokitiedostot ja niiden headerit. My�s yksi tiedosto, jossa kaikki.
		...
		for x in range(x_max):
			for y in range(y_max):
				...
				try:
					...
					# Kirjoitetaan my�s kaikki yhteen tiedostoon. Lis�tty 24.4.2018 Esa
					# Huom! Ei ole t�ysin aikaj�rjestyksess� !!
					fw[x_max].write(line)
